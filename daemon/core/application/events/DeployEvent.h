...
struct DeploySuccess : public IntegrationEventBase {
    ...
    DeploySuccess(std::string deployment_url,
                  std::vector<bxt::Core::Domain::Package>&& packages)
    ...
    std::string message() const override {
        return fmt::format("Deployment successful at {}: {} packages added",
                           deployment_url, added_packages.size());
    }
};
} // namespace bxt::Core::Application::Events
